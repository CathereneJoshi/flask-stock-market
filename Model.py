...
def ModelPredictor(date='2018-01-01') -> float:
    ...
    preResult = -1
    with open(file=r'/home/rejoice/TEMiniProject-SM2/StockMarketPredictorFinal/result.json', mode='r') as f:
        readFile = f.read()
    ...
    try:
        ...
        with open(file=r'/home/rejoice/TEMiniProject-SM2/StockMarketPredictorFinal/result.json', mode='w+') as f:
